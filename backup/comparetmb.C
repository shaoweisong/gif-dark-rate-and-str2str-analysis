{
   ...
   TCanvas *c1 = new TCanvas("comparetmb","rate vs dose",10,10,700,500);
   ...
   double t1[9] = {0.8, 11.4, 46.6, 106.7, 197.8, 588.9, 19451.5, 116481.6, 141670.3};

   double I2[4] = {2.5, 2.7, 2.8, 2.9};
   double t2[4] = {210.7, 503.5, 633.8, 1350.5};

   double I3[9] = {2.1, 2.2, 2.3, 2.4, 2.5, 2.6, 2.7, 2.8, 2.9};
   double t3[9] = {2.9, 11.1, 46.2, 99.2, 182.7, 306.3, 454.0, 561.4, 1337.5};
   ...
   c1->cd(); c1->SetLogy();
   gr11->SetTitle("; High Voltage(kV); TMB dark rates(Hz)");
   gr11->SetMinimum(0.1);
   //gr11->SetMaximum(50);
   ...
   leg1->AddEntry(gr11, "tmb rate on Aug. 2", "lp");
   leg1->AddEntry(gr12, "tmb rate on Aug. 30 before training", "lp");
   leg1->AddEntry(gr13, "tmb rate on Aug. 30 after training", "lp"); 
   //leg1->AddEntry(gr14, "HV = 2.54 kV", "lp");
   leg1->SetBorderSize(0);
   leg1->Draw();

 
   c1->SaveAs("comparetmb.pdf");
