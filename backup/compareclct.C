{
   ...
   TCanvas *c1 = new TCanvas("compareclct","rate vs dose",10,10,700,500);
   ...
   double t1[9] = {287.8, 295.0, 332.7, 387.5, 479.9, 865.1, 19763.7, 117057.0, 142088.2};

   double I2[4] = {2.5, 2.7, 2.8, 2.9};
   double t2[4] = {604.7, 879.1, 997.0, 1710.0};

   double I3[9] = {2.1, 2.2, 2.3, 2.4, 2.5, 2.6, 2.7, 2.8, 2.9};
   double t3[9] = {615.3, 393.9, 393.3, 430.8, 512.3, 644.7, 789.9, 898.8, 1674.6};
   ...
   c1->cd(); c1->SetLogy();
   gr11->SetTitle("; High Voltage(kV); CLCT dark rates(Hz)");
   gr11->SetMinimum(100);
   //gr11->SetMaximum(50);
   ...
   leg1->AddEntry(gr11, "clct rate on Aug. 2", "lp");
   leg1->AddEntry(gr12, "clct rate on Aug. 30 before training", "lp");
   leg1->AddEntry(gr13, "clct rate on Aug. 30 after training", "lp"); 
   //leg1->AddEntry(gr14, "HV = 2.54 kV", "lp");
   leg1->SetBorderSize(0);
   leg1->Draw();

 
   c1->SaveAs("compareclct.pdf");
