# python plot_2D_HV_darkrate_charge.py --tenpctzero --tmb0v me11_txt/TMB_0V_me11_2pct.txt --tmbhv0 me11_txt/TMB_HV0_me11_2pct.txt --data me11_txt/anode_me11_2pct.txt --chambtype 1 --name hv_alct --hvfile me11root/anode_me11_2pct.txt
...
def doplots(layerlist, plotname):
    Canvas = TCanvas("Canvas", "Anode ALCT Rate Density", 200, 10, 1400, 1000)
    for layer in layerlist:
        layer.hist.SetMaximum(20000)
        layer.hist.SetTitle("Anode ALCT Dark Rate Density")
