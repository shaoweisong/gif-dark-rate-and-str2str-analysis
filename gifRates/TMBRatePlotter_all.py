...
if args.test11compare:
    ...
    if args.plotname == 'ME11_TMB':
        ...
        latex_10pct_CF4.SetTextSize(0.03)
        latex_10pct_CF4.SetTextAlign(12)
        latex_10pct_CF4.DrawLatex(150, 2, "10% CF_{4}")
        latex_2pct_CF4 = TLatex()
        latex_2pct_CF4.SetTextSize(0.03)
        latex_2pct_CF4.SetTextAlign(12)
        latex_2pct_CF4.DrawLatex(550, 2, "2% CF_{4}")
        dashed_line2 = TLine(722, TMBRateLimits.lims.GetYaxis().GetXmin(), 722, TMBRateLimits.lims.GetYaxis().GetXmax())
        ...
        latex_5pct_CF4.DrawLatex(780, 2, "5% CF_{4}")        
        plotALCTrates.draw()
        ...
        plotCorrALCTrates.draw()
        plotALCTrates.draw()
        toplot = [plotCorrALCTrates, plotTMBrates,plotALCTrates]
    plotCorrALCTrates.draw()
    plotTMBrates.draw()
    plotCorrALCTrates.draw()
    plotTMBrates.draw()
