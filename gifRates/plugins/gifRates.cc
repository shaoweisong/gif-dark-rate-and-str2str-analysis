...
private:
  ...
  bool handleAnodes  (const edm::Handle<CSCWireDigiCollection> wires, const edm::Handle<CSCALCTDigiCollection> alct);
...
//	  std::cout << "\n\n================================================\n-=\t"<< Event << "\t=-\n";
  ...
  bool fullEvt = handleAnodes(wires, alct);
  if(fullEvt) {
        evtsProceededA++;
  }
...
*****************************************************************************************************/
bool gifRates::handleAnodes(const edm::Handle<CSCWireDigiCollection> wires, const edm::Handle<CSCALCTDigiCollection> alct){
