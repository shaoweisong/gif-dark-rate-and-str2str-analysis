# python plot_2D_HV_darkrate_charge_test.py --tenpctzero --tmb0v me11_txt/TMB_0V_me11_2pct_new.txt --tmbhv0 me11_txt/TMB_HV0_me11_2pct_new.txt --data me11_txt/anode_me11_2pct_hv0.txt --chambtype 1 --name hv_alct_me11 --hvfile me11_corrroot/anode_me11_2pct_test.txt
...
class Layer:
    def __init__(self, nmeas, layernum, charges, chambtype, name=''):
        if chambtype == 1:
            self.nwg = 6
            self.voltage = ['2700', '2800','HV0' ,'2900', '2950', '3000']
        elif chambtype == 2:
            self.nwg = 16
...
def doplots(layerlist, plotname):
    Canvas = TCanvas("Canvas", "Anode Corrected ALCT Rate", 200, 10, 1400, 1000)
    for layer in layerlist:
        if args.full:
            layer.hist.SetMaximum(4000000)
            layer.hist.SetMinimum(0.001)
        else:
            layer.hist.SetMaximum(10000)
            # layer.hist.SetMaximum(20000)
            layer.hist.SetMinimum(0.001)
        layer.hist.SetTitle("Anode Corrected ALCT Dark Rate")
