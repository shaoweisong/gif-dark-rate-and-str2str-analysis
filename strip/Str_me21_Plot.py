...
#first doing between str 1 and 2
    ...
    if args.tenpct:
        ...
        Limits12 = TH2F("limits12", "Strips 1 and 2;Accumulated Charge (mC/cm);Strip 1 to Strip 2 Resistance (T#Omega)", 1000, 0, 365, 100, 10**(-3), 10**(4))
...
#Now str 2 and 3
    ...
    if args.tenpct:
        ...
        Limits23 = TH2F("limits23", "Strips 2 and 3;Accumulated Charge (mC/cm);Strip 2 to Strip 3 Resistance (T#Omega)", 1000, 0, 365, 100, 10**(-3), 10**(4))
